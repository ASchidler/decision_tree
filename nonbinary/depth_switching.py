import nonbinary.depth_partition as enc1
import nonbinary.depth_avellaneda_sat as enc2
...
def get_tree_size(tree):
    return enc2.get_tree_size(tree) if tree.get_depth() >= _switch_threshold \
        else enc1.get_tree_size(tree)
